...
namespace BusinessLayer
{
    ...
    {
        private DL_Negocio objcd_negocio = new DL_Negocio();
        ...
        public bool GuardarDatos(Negocio obj, out string Mensaje)
        {
            ...
            if (obj.Nombre == "")
            {
                Mensaje += "Es necesario ingresar un nombre\n";
            }

            if (obj.Rut == "")
            {
                Mensaje += "Es necesario ingresar un rut\n";
            }

            if (obj.Direccion == "")
            {
                Mensaje += "Es necesario ingresar una direccion\n";
            }
